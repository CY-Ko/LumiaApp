...
- (void)setup
{
    ...
    if (ifdTableArray) {
        ...
        //get camera maker
        NSString *dateMaker = [self getMake:ifdTableArray];
        NSLog(@"TAG_Make= %@",dateMaker);
        //get camera model
        NSString *dateModel = [self getModel:ifdTableArray];
        NSLog(@"TAG_Model= %@",dateModel);
...
- (NSString*)getMake:(void*)ifdArray
{
    NSString *date = nil;
    int IFDs[4] = {IFD_0TH, IFD_1ST, -1};
    int TAGs[4] = {TAG_Make, TAG_Make, -1};
...
// get the Exif "DateTime" value
- (NSString*)getModel:(void*)ifdArray
{
    NSString *date = nil;
    int IFDs[4] = {IFD_0TH, IFD_1ST, -1};
    int TAGs[4] = {TAG_Model, TAG_Model, -1};
